...
from albumy.extensions import bootstrap, db, mail, moment, login_manager, dropzone, csrf, avatars, whooshee, migrate
...
def register_commands(app: Flask):
    ...
    @click.option('--collect', default=100, help='Quantity of collects, default is 100.')
    @click.option('--follow', default=30, help='Quantity of follows, default is 30.')
    @click.option('--notification', default=100, help='Quantity of notifications, default is 100.')
