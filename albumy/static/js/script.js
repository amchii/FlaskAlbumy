$(function () {
    ...
    function show_profile_popover(e) {
        ...
        hover_timer = setTimeout(function () {
            ...
            $.ajax({
                type: 'GET',
                url: $el.data('href') + '?time=' + new Date().getTime(),
    ...
    function hide_profile_popover(e) {
        ...
        if (hover_timer) {
            ...
            setTimeout(function () {
                // 在鼠标离开触发元素时，同时离开弹窗才关闭弹窗，
                // 也就是弹窗元素不在hover状态，下方选择器结果length为0
    ...
    var popoverEle = $('.profile-popover');

    popoverEle.hover(show_profile_popover.bind(this), hide_profile_popover.bind(this));
    ...
    $('#cancel-desription').click(function () {
